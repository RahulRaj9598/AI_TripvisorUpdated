...
router.post('/', authenticateUser, uploadMultiple, handleUploadError, async (req, res) => {
  try {
...
// Update a blog post
router.put('/:id', authenticateUser, uploadMultiple, handleUploadError, async (req, res) => {
  try {
    const { title, content, destination, category, tags } = req.body;
...
router.post('/:id/poll', authenticateUser, async (req, res) => {
  try {
...
router.post('/:id/poll/vote', authenticateUser, async (req, res) => {
  try {
...
router.put('/:id/poll/end', authenticateUser, async (req, res) => {
  try {
    const blog = await Blog.findById(req.params.id);
...
router.delete('/:id/poll', authenticateUser, async (req, res) => {
  try {
    const blog = await Blog.findById(req.params.id);
